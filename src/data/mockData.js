...
export const products = [
  // ── Худі базові (19) ──────────────────────────────────────────
  { id: 'hoodie-black',       nameUk: 'Чорний худі',               category: 'hoodie-basic', image: `${b}Чорний перед худі базовий.jpg` },
  { id: 'hoodie-white',       nameUk: 'Білий худі',                category: 'hoodie-basic', image: `${b}Білий перед худі базовий.jpg` },
  { id: 'hoodie-gray',        nameUk: 'Сірий худі',                category: 'hoodie-basic', image: `${b}Сірий перед худі базовий.jpg` },
  { id: 'hoodie-graphite',    nameUk: 'Графітовий худі',           category: 'hoodie-basic', image: `${b}Графіт перед худі базовий.jpg` },
  { id: 'hoodie-beige',       nameUk: 'Бежевий худі',              category: 'hoodie-basic', image: `${b}Бежевий худі базовий.jpg` },
  { id: 'hoodie-lightblue',   nameUk: 'Блакитний худі',            category: 'hoodie-basic', image: `${b}Блакитний перед худі базовий.jpg` },
  { id: 'hoodie-darkgreen',   nameUk: 'Темно-зелений худі',        category: 'hoodie-basic', image: `${b}Темно зелений перед худі базовий.jpg` },
  { id: 'hoodie-khaki',       nameUk: 'Хакі худі',                 category: 'hoodie-basic', image: `${b}Хакі перед худі базовий.jpg` },
  { id: 'hoodie-red',         nameUk: 'Червоний худі',             category: 'hoodie-basic', image: `${b}Червоний перед худі базовий.jpg` },
  { id: 'hoodie-burgundy',    nameUk: 'Бордовий худі',             category: 'hoodie-basic', image: `${b}Бордовий перед худі базовий.jpg` },
  { id: 'hoodie-pink',        nameUk: 'Рожевий худі',              category: 'hoodie-basic', image: `${b}Рожевий перед худі базовий.jpg` },
  { id: 'hoodie-orange',      nameUk: 'Помаранчевий худі',         category: 'hoodie-basic', image: `${b}Помаранчевий дитячий перед худі базовий.jpg` },
  { id: 'hoodie-vanilla',     nameUk: 'Ванільний худі',            category: 'hoodie-basic', image: `${b}Ванільний перед худі базовий.jpg` },
  { id: 'hoodie-lavender',    nameUk: 'Лавандовий худі',           category: 'hoodie-basic', image: `${b}Лавандовий перед худі базовий.jpg` },
  { id: 'hoodie-mint',        nameUk: "М'ятний худі",              category: 'hoodie-basic', image: `${b}М_ятний перед худі базовий.jpg` },
  { id: 'hoodie-chocolate',   nameUk: 'Шоколадний худі',           category: 'hoodie-basic', image: `${b}Шоколадний перед худі базовий.webp` },
  { id: 'hoodie-purple',      nameUk: 'Фіолетовий худі',           category: 'hoodie-basic', image: `${b}Фіолетовий худі базовий.jpg` },
  { id: 'hoodie-jh-blue',     nameUk: 'Блакитний худі JH',         category: 'hoodie-basic', image: `${b}худі блакитний базовий.jpg` },
  { id: 'hoodie-jh-yellow',   nameUk: 'Жовтий худі JH',            category: 'hoodie-basic', image: `${b}худі жовтий базовий.jpg` },
  ...
  { id: 'sweat-lightblue',  nameUk: 'Блакитний світшот',      category: 'sweatshirt', image: `${b}Блакитний перед світшот базовий.jpg` },
  { id: 'sweat-darkblue',   nameUk: 'Темно-синій світшот',    category: 'sweatshirt', image: `${b}Темно синій перед світшот базовий.jpg` },
  { id: 'sweat-darkgreen',  nameUk: 'Темно-зелений світшот',  category: 'sweatshirt', image: `${b}Темно зелений перед світшот базовий.jpg` },
  { id: 'sweat-khaki',      nameUk: 'Хакі світшот',           category: 'sweatshirt', image: `${b}Хакі перед світшот базовий.jpg` },
  { id: 'sweat-red',        nameUk: 'Червоний світшот',       category: 'sweatshirt', image: `${b}Червоний перед світшот базовий.jpg` },
  { id: 'sweat-burgundy',   nameUk: 'Бордовий світшот',       category: 'sweatshirt', image: `${b}Бордовий перед світшот базовий.jpg` },
  { id: 'sweat-pink',       nameUk: 'Рожевий світшот',        category: 'sweatshirt', image: `${b}Рожевий перед світшот базовий.jpg` },
  { id: 'sweat-orange',     nameUk: 'Помаранчевий світшот',   category: 'sweatshirt', image: `${b}Помаранчевий дитячий перед світшот базовий.jpg` },
  { id: 'sweat-yellow',     nameUk: 'Жовтий світшот',         category: 'sweatshirt', image: `${b}жовтий світшот базовий.jpg` },
  { id: 'sweat-purple',     nameUk: 'Фіолетовий світшот',     category: 'sweatshirt', image: `${b}фіолетовий світшот базовий.jpg` },
